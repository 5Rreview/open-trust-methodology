...
How the 5R Trust platform handles personal data in the context of trust scoring and review management.
...
- Maintaining the integrity of trust scores
...
| Rating | Trust score calculation | As long as review exists |
...
- **Standard case:** Review is deleted, trust score recalculated
...
- Companies can see their trust score breakdown
