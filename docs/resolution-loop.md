...
## The Problem: Negative Contribution Bias

On most review platforms:
- Satisfied users rarely write reviews
- Dissatisfied users write actively
- Negative skew appears
...
```
1. User writes review (including issues)
...
|--------|-------------|----------|
| Response Rate | % of reviews with company response | Yes, on company profile |
| Resolution Rate | % of reported issues resolved | Yes, on company profile |
...
| Instead of | We use |
|------------|--------|
| "Write a complaint" | "Share your experience" |
