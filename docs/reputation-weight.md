...
If the weight were visible, bad actors would game it. By keeping the coefficient internal, the system silently reduces the influence of suspicious accounts without creating confrontation.

## Weight Factors

The reputation weight is calculated from multiple factors:

| Factor | Description | Effect |
|--------|-------------|--------|
| Account age | Time since registration | Newer accounts carry less weight |
| Review diversity | Reviews across different companies | Diverse reviewers are more credible |
| Review quality | Average quality grade across reviews | Higher quality writing = more influence |
| Verification | Verified purchase, linked account | Verified reviewers carry more weight |
| Community validation | Helpful votes from other users | Community-endorsed reviews matter more |
| Response interaction | Engagement with company responses | Active dialogue signals genuine intent |
